...
export function utxocontext_active(a: number): number;
...
export function __wbg_get_transactionrecord_value(a: number): number;
export function __wbg_set_transactionrecord_value(a: number, b: number): void;
export function __wbg_get_transactionrecord_blockDaaScore(a: number): number;
export function __wbg_set_transactionrecord_blockDaaScore(a: number, b: number): void;
...
export function __wbindgen_export_12(a: number, b: number): void;
export function __wbindgen_export_13(a: number, b: number, c: number): void;
export function __wbindgen_export_14(a: number): void;
export function __wbindgen_export_15(a: number, b: number, c: number): void;
